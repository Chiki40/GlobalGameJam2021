...
namespace Twity
{
    ...
    public class Client
    {
        ...
        public static IEnumerator GetV2(string APIPath, Dictionary<string, string> APIParams, TwitterCallback callback)
        {
            string REQUEST_URL = "https://api.twitter.com/2/" + APIPath;
            SortedDictionary<string, string> parameters = Helper.ConvertToSortedDictionary(APIParams);
        ...
        public static IEnumerator PostImage(string APIPath, Dictionary<string, string> APIParams, TwitterCallback callback)
        {
            ...
            if (endpointForFormdata.IndexOf(APIPath) != -1)
            {
                ...
                {
                    if(parameter.Key == "media_data")
                    {
                        form.AddBinaryData("media", System.Convert.FromBase64String(parameter.Value));
                    }
                    else
                    {
